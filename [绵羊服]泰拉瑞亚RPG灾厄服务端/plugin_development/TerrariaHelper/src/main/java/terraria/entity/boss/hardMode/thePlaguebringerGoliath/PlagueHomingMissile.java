...
public class PlagueHomingMissile extends EntitySlime {
    ...
    static double FLIGHT_SPEED = 2, ACCELERATION_MIN = 0.5, ACCELERATION_MAX = 0.5, DETONATE_RADIUS_SQR = 4;
    ...
    public PlagueHomingMissile(World world) {
        super(world);
        super.die();
    }
    ...
    public PlagueHomingMissile(ThePlaguebringerGoliath owner) {
