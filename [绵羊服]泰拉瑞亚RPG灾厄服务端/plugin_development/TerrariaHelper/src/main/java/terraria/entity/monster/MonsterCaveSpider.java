...
public class MonsterCaveSpider extends EntityCaveSpider {
    ...
    public MonsterCaveSpider(World world) {
        super(world);
        die();
    }
    ...
    public MonsterCaveSpider(Player target, String type, Location spawnLoc) {
        this(target, type, spawnLoc, false);
    }
    public MonsterCaveSpider(Player target, String type, Location spawnLoc, boolean isMonsterPart) {
