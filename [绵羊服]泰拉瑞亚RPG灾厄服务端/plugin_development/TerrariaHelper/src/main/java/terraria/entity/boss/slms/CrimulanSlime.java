...
public class CrimulanSlime extends EntitySlime {
    ...
    public static final double BASIC_HEALTH = 20736 * 2;
    ...
    public CrimulanSlime(TheSlimeGod owner) {
        this(owner, SlimeSize.BIG, owner.getBukkitEntity());
    }
    public CrimulanSlime(TheSlimeGod owner, SlimeSize size, Entity spawner) {
