...
public class MonsterWitherSkeleton extends EntitySkeletonWither {
    ...
    public MonsterWitherSkeleton(World world) {
        super(world);
        die();
    }
    ...
    public MonsterWitherSkeleton(Player target, String type, Location spawnLoc) {
        this(target, type, spawnLoc, false);
    }
    public MonsterWitherSkeleton(Player target, String type, Location spawnLoc, boolean isMonsterPart) {
