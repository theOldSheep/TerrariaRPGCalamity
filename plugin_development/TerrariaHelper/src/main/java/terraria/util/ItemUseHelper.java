...
public class ItemUseHelper {
            ...
            case "虫洞药水": {
                if (quickBuffType == QuickBuffType.NONE) {
                    if (!ply.getScoreboardTags().contains("wormHolePotionUsed")) {
                        ...
                        ply.sendMessage("§a您上次服用的虫洞药水还未生效");
                    }
    ...
    protected static boolean isWeaponUseCancelledByEvt(Player ply) {
        TerrariaWeaponSwingEvent evt = new TerrariaWeaponSwingEvent(ply);
    ...
    protected static void handleMeleeSwing(Player ply, HashMap<String, Double> attrMap, Vector lookDir,
        ...
        switch (interpolateType) {
            ...
            case 0:
            case 1:
                if (DamageHelper.getDamageType(ply) == DamageHelper.DamageType.MELEE) {
            ...
            switch (weaponType) {
                case "星光": {
                    ...
                    if (shouldStrike) {
                        ...
                        strikeYaw += Math.random() * 10 - 5;
                        strikePitch += Math.random() * 10 - 5;
                    }
                    break;
                }
                case "水电剑":
                        ...
                        strikeLineInfo
                                .setDamagedFunction((hitIndex, entityHit, hitLoc) -> {
                                    ...
                                    EntityHelper.spawnProjectile(ply, hitLoc, projVel,
                                            attrMap, DamageHelper.DamageType.MELEE, "电火花");
                                });
                    }
                    break;
                }
                    ...
                    if (shouldStrike) {
                        strikeLineInfo
                                .setDamagedFunction((hitIndex, entityHit, hitLoc) -> {
                                    ...
                                    int invulnerabilityTicks = 4;
                                    EntityHelper.handleEntityTemporaryScoreboardTag(ply,
                                            DamageHelper.getInvulnerabilityTickName(DamageHelper.DamageType.MELEE),
                                            invulnerabilityTicks);
                                    EntityHelper.handleEntityTemporaryScoreboardTag(ply,
                                            DamageHelper.getInvulnerabilityTickName(DamageHelper.DamageType.TRUE_MELEE),
                                            invulnerabilityTicks);
                                });
                    }
                    break;
                    ...
                    if (shouldStrike) {
                        strikeLineInfo
                                .setDamagedFunction((hitIndex, entityHit, hitLoc) -> {
                                    ...
                                    Location predictedLoc = AimHelper.helperAimEntity(ply, entityHit, aimHelper);
                                    ...
                                    EntityHelper.spawnProjectile(ply, predictedLoc, projVel, attrMap,
                                            DamageHelper.DamageType.MELEE, "伽利略小行星");
                                });
                    }
                    break;
                }
                        ...
                        strikeLineInfo
                                .setDamagedFunction((hitIndex, entityHit, hitLoc) -> {
                                    ...
                                    for (int i = (int) (Math.random() * 3); i < 3; i++) {
                                        ...
                                        EntityHelper.spawnProjectile(ply, hitLoc, projVel,
                                                attrMap, DamageHelper.DamageType.MELEE, "硫磺火间歇泉");
                                    }
                                });
                    }
                    break;
                                ...
                                .setDamagedFunction((hitIndex, entityHit, hitLoc) -> {
                                    ...
                                    if (Math.random() < critRate)
                                        for (int i = (int) (Math.random() * 2); i < 2; i++) {
                                            ...
                                            projVel.multiply(1);
                                            EntityHelper.spawnProjectile(ply, hitLoc, projVel,
                                                    attrMap, DamageHelper.DamageType.MELEE, "追踪火球");
                                        }
                                });
                    }
                    break;
                        ...
                        strikeLineInfo
                                .setDamagedFunction((hitIndex, entityHit, hitLoc) -> {
                                    ...
                                    for (int i = 0; i < 5; i++) {
                                        ...
                                        EntityHelper.spawnProjectile(ply, hitLoc, projVel,
                                                plagueSeekerAttrMap, DamageHelper.DamageType.MELEE, "瘟疫搜寻者");
                                    }
                                });
                    }
                    break;
                ...
                case "磁能分割刀": {
                    ...
                    if (shouldStrike) {
                        ...
                        EntityHelper.spawnProjectile(ply, projVel,
                                projAttrMap, DamageHelper.DamageType.MELEE, "能量脉冲");
                    }
                    break;
                }
                case "幻星矛": {
                                ...
                                .setDamagedFunction((hitIndex, entityHit, hitLoc) -> {
                                    ...
                                    if (Math.random() < critRate) {
                                        ...
                                        EntityHelper.spawnProjectile(ply, hitLoc.subtract(locOffset), projVel,
                                                attrMap, DamageHelper.DamageType.MELEE, "彗星");
                                    }
                                });
                    }
                    break;
                ...
                case "女妖之爪": {
                    ...
                    if (shouldStrike) {
                        ...
                        Vector projVel = getPlayerAimDir(ply, shootLoc, 2.75, "灵魂鬼爪", false, 0);
                        projVel.normalize().multiply(2.75);

                        EntityHelper.spawnProjectile(ply, shootLoc, projVel,
                                attrMap, DamageHelper.DamageType.MELEE, "灵魂鬼爪");
                    }
                    break;
                }
                case "钨钢螺丝刀_RIGHT_CLICK": {
                    ...
                    if (shouldStrike) {
                        ...
                        strikeLineInfo
                                .setDamagedFunction((hitIndex, entityHit, hitLoc) -> {
                                    AttributeHelper.getAttrMap(entityHit).put("damageMeleeMulti", 6.0);
                                    AttributeHelper.getAttrMap(entityHit).put("crit", 100.0);
                ...
                case "旧神之誓约_RIGHT_CLICK": {
                    ...
                    if (shouldStrike) {
                        ...
                        if (currentIndex == 0) {
                            ...
                            plyVel.multiply(2);
                            EntityMovementHelper.setVelocity(ply, plyVel);
                        }
                        ...
                        strikeLineInfo
                                .setDamagedFunction((hitIndex, entityHit, hitLoc) -> {
                                    ...
                                    if (entityHit instanceof Projectile) {
                                        EntityHelper.handleEntityTemporaryScoreboardTag(ply,
                                                DamageHelper.getInvulnerabilityTickName(DamageHelper.getDamageType(entityHit)),
                                                invulnerabilityTicks);
                                    }
                                ...
                                .setShouldDamageFunction( (e) ->
                                        DamageHelper.checkCanDamage(e, ply, true) && !finalDamagedList.contains(e));
                        // render scissors
                        switch (weaponType) {
                            case "元素方舟_RIGHT_CLICK":
                            case "鸿蒙方舟_RIGHT_CLICK": {
                ...
                case "银河[北斗之眸]": {
                    ...
                    if (currentIndex == 0) {
                        ...
                        EntityHelper.spawnProjectile(ply, projVel, passiveProjAttrMap,
                                DamageHelper.DamageType.MELEE, "巨蟹之礼星环");
                    }
                    // durability tweak
                    if (currentIndex % 2 == 0)
                ...
                case "银河[仙女之跃]_RIGHT_CLICK": {
                    ...
                    if (currentIndex == 0) {
                        ...
                        attrMap.put("damage", attrMap.get("damage") * durabilityRatio);
                    }
                    ...
                    strikeLineInfo
                            ...
                            .setDamagedFunction((hitIdx, hitEntity, hitLoc) -> {
                                ...
                                EntityHelper.handleEntityTemporaryScoreboardTag(ply,
                                        ...
                                        invulnerabilityTicks);
                                EntityHelper.handleEntityTemporaryScoreboardTag(ply,
                                        DamageHelper.getInvulnerabilityTickName(DamageHelper.DamageType.ARROW),
                                        invulnerabilityTicks);
                                EntityHelper.handleEntityTemporaryScoreboardTag(ply,
                                        DamageHelper.getInvulnerabilityTickName(DamageHelper.DamageType.MAGIC),
                                        invulnerabilityTicks);
                            })
                ...
                case "焚灭天惩": {
                    ...
                    EntityHelper.spawnProjectile(ply, targetLoc, projVel, attrMap, DamageHelper.DamageType.MELEE, "焚灭天惩燃烧陨石");
                    break;
                }
                case "光棱破碎者": {
                    shouldStrike = true;
                ...
                case "星流之刃_RIGHT_CLICK": {
                    ...
                    if (currentIndex == 0) {
                        ...
                        plyVel = EntityMovementHelper.getRawVelocity(ply).normalize();
                    ...
                    if (currentIndex == maxIndex)
                        EntityMovementHelper.setVelocity(ply, new Vector());
                                ...
                                for (int i = 1; i <= 5; i ++) {
                                    Bukkit.getScheduler().runTaskLater(TerrariaHelper.getInstance(), () -> {
                                        ...
                                        EntityHelper.spawnProjectile(ply, spawnLoc, projVel, attrMap,
                                                DamageHelper.DamageType.MELEE, "星流斩切光束");
                                    }, i);
                                }
                                // recoil
                                EntityMovementHelper.setVelocity(ply, lookDirCopy);
                            })
                            .setLingerDelay(1);
                    break;
                }
            ...
            if (weaponType.equals("天顶剑")) {
                ...
                switch (weaponType) {
                        ...
                        if (currentIndex == 0) {
                            ...
                            for (int i = 0; i < shootAmount; i ++) {
                                ...
                                targetLoc.add(
                                        ...
                                        Math.random() * 2 - 1,
                                        Math.random() * 2 - 1);
                                Location shootLoc = aimLoc.clone().add(Math.random() * 16 - 8, 25, Math.random() * 16 - 8);
                                Vector velocity = targetLoc.subtract(shootLoc).toVector().multiply(1d / ticksDelay);
                                EntityHelper.spawnProjectile(ply, shootLoc, velocity, attrMap,
                                        DamageHelper.DamageType.MELEE, projectileName);
                            }
                        }
                        break;
                    }
                    ...
                    case "相位剑": {
                        ...
                        if (currentIndex == 0) {
                            ...
                            EntityHelper.spawnProjectile(ply, projVel, attrMap,
                                    DamageHelper.DamageType.MELEE, "热熔光刃");
                        }
                        break;
                    }
                    case "宇宙暗流": {
                    ...
                    case "银河[凤凰之耀]": {
                        ...
                        if (shouldShoot) {
                            HashMap<String, Double> projAttrMap = (HashMap<String, Double>) attrMap.clone();
                            projAttrMap.put("damage", projAttrMap.getOrDefault("damage", 2000d) * 0.35);
                            // projectile
                            Vector projVel = MathHelper.randomVector();
                            projVel.multiply(3);
                            EntityHelper.spawnProjectile(ply, projVel, projAttrMap,
                        ...
                        if (currentIndex == 0) {
                            ...
                            projVel.multiply(2.5);
                            EntityHelper.spawnProjectile(ply, projVel, passiveProjAttrMap,
                                    DamageHelper.DamageType.MELEE, "摩羯之祈星环");
                        }
                        break;
                    }
                    case "银河[白羊之怒]": {
                    ...
                    case "天神之剑": {
                        if (currentIndex == 0) {
                            for (int i = 0; i < 3; i++) {
                                ...
                                EntityHelper.spawnProjectile(ply, spawnLoc, projVel, attrMap,
                                        DamageHelper.DamageType.MELEE, projectileType);
                            }
                        }
                        break;
                    }
                    ...
                    case "混乱之刃": {
                        strikeLineInfo.setDamagedFunction( (hitIdx, hitEntity, hitLoc) -> {
                            ...
                            DamageHelper.handleDamage(ply, hitEntity, damage, DamageHelper.DamageReason.STRIKE);
                        });
                        break;
                    }
                    case "月炎之锋": {
                        String projectileName = "月之耀斑";
                        double projectileSpeed = 3;
                        int shootAmountMin = 1, shootAmountMax = 3;
                        ...
                        strikeLineInfo.setDamagedFunction( (hitIdx, hitEntity, hitLoc) -> {
                            for (int i = (int) (Math.random() * initialRdmIdx); i < terminateIdx; i ++) {
                                ...
                                EntityHelper.spawnProjectile(ply, spawnLoc, projVel,
                                        attrMap, DamageHelper.DamageType.MELEE, projectileName);
                            }
                        });
                        break;
                    }
                                ...
                                if (livingHitEntity.getHealth() * 2 < livingHitEntity.getMaxHealth()) {
                                    for (int projYaw = 0; projYaw <= 360; projYaw += 120) {
                                        ...
                                        EntityHelper.spawnProjectile(ply, hitLoc, projVel, attrMap,
                                                DamageHelper.DamageType.MELEE, "彩虹弹幕");
                                    }
                                }
                            }
                        });
                    ...
                    case "狱火重剑": {
                        if (currentIndex == 0) {
                            for (int i = 0; i < 3; i ++) {
                                ...
                                projVel.add(MathHelper.randomVector().multiply( projVel.length() * 0.02 ) );
                                projVel.normalize().multiply(2.5);
                                EntityHelper.spawnProjectile(ply, projVel,
                                        projAttrMap, DamageHelper.DamageType.MELEE, projectileType);
                            }
                        }
                        break;
                    }
                        ...
                        if (currentIndex == 0) {
                            ...
                            for (int i = 0; i < 3; i ++) {
                                ...
                                EntityHelper.spawnProjectile(ply,
                                        projVel, attrMap,
                                        DamageHelper.DamageType.MELEE, "禁忌镰刀");
                                projPitch += 15;
                            }
                        }
                        double critRate = (attrMap.getOrDefault("crit", 4d) +
                    ...
                    case "熵阔剑": {
                        if (currentIndex == 0) {
                            for (int i = 0; i < 5; i ++) {
                                ...
                                EntityHelper.spawnProjectile(ply, projVel,
                                        projAttrMap, DamageHelper.DamageType.MELEE, "熵离子球");
                            }
                        }
                        break;
                    }
                    case "季节长剑": {
                        if (currentIndex == 0) {
                            ...
                            projVel.normalize().multiply(3.25);
                            EntityHelper.spawnProjectile(ply, projVel,
                                    projAttrMap, DamageHelper.DamageType.MELEE, projType);
                        }
                        break;
                    }
                    case "破坏重剑": {
                        if (currentIndex == 0) {
                            ...
                            Location targetLoc = ply.getEyeLocation().add(
                                    getPlayerAimDir(ply, ply.getEyeLocation(), projSpd, "破坏重剑剑气", false, 0) );
                            for (int i = 1; i <= 8; i ++) {
                                Location spawnLoc = targetLoc.clone().add(
                                        Math.random() * 10 - 5, Math.random() * 10 + 15, Math.random() * 10 - 5);
                                Vector projVel = MathHelper.getDirection(spawnLoc, targetLoc, projSpd);
                                EntityHelper.spawnProjectile(ply, spawnLoc, projVel,
                                        attrMap, DamageHelper.DamageType.MELEE, "破坏重剑剑气");
                            }
                        }
                        break;
                    }
                    case "爆破剑": {
                        if (currentIndex == 0) {
                            ...
                            for (int i = 1; i <= 8; i ++) {
                                ...
                                if (i <= 4) {
                                    Location targetLoc = ply.getEyeLocation().add(
                                            getPlayerAimDir(ply, ply.getEyeLocation(), projSpd, "爆破剑气", false, 0) );
                                    projVel = MathHelper.getDirection(spawnLoc, targetLoc, projSpd);
                                }
                                else {
                                ...
                                EntityHelper.spawnProjectile(ply, spawnLoc, projVel,
                                        attrMap, DamageHelper.DamageType.MELEE, "爆破剑气");
                            }
                        }
                        break;
                    }
                    ...
                    case "星河之刃": {
                        if (currentIndex == 0) {
                            double projSpd = 3.35;
                            String projType = "星河陨石";
                            Location targetLoc = getPlayerTargetLoc(new AimHelper.PlyTargetLocInfo(ply,
                                    new AimHelper.AimHelperOptions(projType)
                                            .setAimMode(false)
                                            .setProjectileSpeed(projSpd), true));
                            for (int i = 0; i < 5; i ++) {
                                Location spawnLoc = targetLoc.clone().add(
                                        Math.random() * 8 - 4, Math.random() * 5 + 15, Math.random() * 8 - 4);
                                Location aimLoc = targetLoc.clone().add(
                                        Math.random() * 2 - 1, Math.random() * 2 - 1, Math.random() * 2 - 1);
                                Vector projVel = MathHelper.getDirection(spawnLoc, aimLoc, projSpd);
                                EntityHelper.spawnProjectile(ply, spawnLoc, projVel,
                                        attrMap, DamageHelper.DamageType.MELEE, projType);
                            }
                        }
                        break;
                    }
                    ...
                    case "镜之刃": {
                        if (currentIndex == 0) {
                            if (Math.random() < 0.5) {
                                ...
                                projVel.multiply(3);
                                EntityHelper.spawnProjectile(ply, projVel,
                                        attrMap, DamageHelper.DamageType.MELEE, "镜之刃镜子");
                            }
                        }

                        strikeLineInfo.setDamagedFunction( (hitIdx, hitEntity, hitLoc) -> {
                            HashMap<String, Double> victimAttrMap = AttributeHelper.getAttrMap(hitEntity);
                            double extraDamage = Math.min(1000, victimAttrMap.getOrDefault("damage", 1d) );
                            DamageHelper.handleDamage(ply, hitEntity, extraDamage,
                                    DamageHelper.DamageReason.STRIKE);
                        });
                        break;
                    }
                    case "狮心圣裁": {
                        strikeLineInfo.setDamagedFunction( (hitIdx, hitEntity, hitLoc) -> {
                            EntityHelper.applyEffect(ply, "狮心圣裁能量外壳", 200);
                        });
                        break;
                    }
                    case "宙能波纹剑": {
                        if (currentIndex == 0) {
                            double projSpd = 3.4;
                            for (int i = 0; i < 3; i ++) {
                                Vector projVel = getPlayerAimDir(ply, ply.getEyeLocation(), projSpd, "宙魔之纹", false, 0);
                                projVel.add( MathHelper.randomVector().multiply(projVel.length() * 0.05) );
                                projVel.normalize().multiply(projSpd);
                                EntityHelper.spawnProjectile(ply, projVel,
                                        attrMap, DamageHelper.DamageType.MELEE, "宙魔之纹");
                            }
                        }
                        break;
                    }
                    case "暴政": {
                        strikeLineInfo.setDamagedFunction( (hitIdx, hitEntity, hitLoc) -> {
                            if (hitIdx == 1) {
                                ...
                                projVel.multiply(3);
                                EntityHelper.spawnProjectile(ply, shootLoc, projVel,
                                        attrMap, DamageHelper.DamageType.MELEE, "精华火焰");
                            }
                        });
                        break;
                    }
                    case "禅心剑": {
                        if (currentIndex == 0) {
                            double projSpd = 3.5;
                            Vector projVel = getPlayerAimDir(ply, ply.getEyeLocation(), projSpd, "爆炸禅心导弹", false, 0);
                            ...
                            for (int i = -1; i <= 1; i ++) {
                                ...
                                EntityHelper.spawnProjectile(ply, spawnLoc, projVel,
                                        attrMap, DamageHelper.DamageType.MELEE,
                                        i == 0 ? "爆炸禅心导弹" : "分裂禅心导弹");
                            }
                        }
                        break;
                    ...
                    case "盖尔大剑": {
                        if (currentIndex == 0) {
                            ...
                            switch (swingAmount % 3) {
                                case 0:
                                    projSpd = 3;
                                    projVel = getPlayerAimDir(ply, ply.getEyeLocation(), projSpd, "跟踪血骷髅", false, 0);
                                    MathHelper.setVectorLength(projVel, projSpd);
                                    for (int i = -1; i <= 1; i += 2) {
                                        Vector spawnLocOffset = MathHelper.vectorFromYawPitch_approx(
                                                plyYaw, plyPitch + i * 15);
                                        Location spawnLoc = ply.getEyeLocation().add(spawnLocOffset);
                                        EntityHelper.spawnProjectile(ply, spawnLoc, projVel,
                                                attrMap, DamageHelper.DamageType.MELEE, "跟踪血骷髅");
                                    }
                                    break;
                                case 1:
                                    projSpd = 3.5;
                                    projVel = getPlayerAimDir(ply, ply.getEyeLocation(), projSpd, "巨大血骷髅", false, 0);
                                    projVel.normalize().multiply(projSpd);
                                    Location spawnLoc = ply.getEyeLocation();
                                    EntityHelper.spawnProjectile(ply, spawnLoc, projVel,
                                            attrMap, DamageHelper.DamageType.MELEE, "巨大血骷髅");
                                    break;
                                case 2:
                                default:
                                    double dmg = attrMap.getOrDefault("damage", 100d);
                                    strikeLineInfo.setDamagedFunction((hitIndex, hitEntity, hitLoc) -> {
                                        DamageHelper.handleDamage(ply, hitEntity, dmg, DamageHelper.DamageReason.STRIKE);
                                    });
                            }
                            // charge up
                            int charge = getDurability(weaponItem, 50);
                            if (charge++ >= 50) {
                                charge = 0;
                                for (int i = 0; i < 20; i ++) {
                            ...
                            setDurability(weaponItem, 50, charge);
                        }
                        break;
                    }
                    case "星流之刃": {
                        ...
                        strikeLineInfo.setDamagedFunction( (hitIdx, hitEntity, hitLoc) -> {
                            ...
                            if (currCharge == 8) {
                                EntityHelper.spawnProjectile(ply, hitLoc, new Vector(), attrMap,
                                        DamageHelper.DamageType.MELEE, "星流能量爆炸");
                            }
                        });
                    ...
                    case "无限大地": {
                        ...
                        strikeLineInfo.setDamagedFunction( (hitIdx, hitEntity, hitLoc) -> {
                            // heal
                            PlayerHelper.heal(ply, (int) (Math.random() * 10));
                            // spawn projectiles
                            Location aimLoc = AimHelper.helperAimEntity(ply, hitEntity, aimHelper);
                            ...
                            EntityHelper.spawnProjectile(ply, spawnLoc, projVel, attrMap,
                                    DamageHelper.DamageType.MELEE, "三色大地流星");
                        });
                        break;
                    }
                }
                for (int i = indexStart; i < indexEnd; i ++) {
                    ...
                    switch (weaponType) {
                        ...
                        case "炼狱": {
                            if ( i == (int) (loopTimes * 0.3) ||
                                    i == (int) (loopTimes * 0.375) ||
                            ...
                            // for simpler upward/downward swings
                                ...
                                if (isDownwardSwing && i == 0) {
                                    ...
                                    for (int idxStar = 0; idxStar < 4; idxStar++) {
                                        ...
                                        starProjVel.multiply(isArkOfElements ? 2.25 : 2.75);
                        ...
                        case "泰拉阔剑": {
                            ...
                            if (i == (int) (loopTimes * 0.5)) {
                                double projSpd = 4.75;
                                Vector projVel = getPlayerAimDir(ply, ply.getEyeLocation(), projSpd, "泰拉能量矢", false, 0);
                                projVel.normalize().multiply(projSpd);
            ...
            if ((swingAmount + 1) % shootInterval == 0) {
                ...
                for (int i = 0; i < shootAmount; i ++) {
                    ...
                    if (stabOrSwing) {
                        ...
                        MathHelper.setVectorLength( projVel, projectileSpeed );
                        spawnedProjectile = EntityHelper.spawnProjectile(ply, shootLoc,
                                projVel, attrMapProjectile, DamageHelper.DamageType.MELEE, projectileType);
                    } else {
                        Vector projVel;
                        switch (itemType) {
                            case "风之刃":
                            case "风暴管束者":
                                ...
                                break;
                            default:
                                projVel = getPlayerAimDir(ply, shootLoc, projectileSpeed, projectileType, false, 0);
                                MathHelper.setVectorLength( projVel, projectileSpeed );
                        }
                        spawnedProjectile = EntityHelper.spawnProjectile(ply, shootLoc,
                                projVel, attrMapProjectile, DamageHelper.DamageType.MELEE, projectileType);
    ...
    protected static Boomerang playerUseBoomerang(Player ply, String itemType, String weaponType,
        ...
        AimHelper.AimHelperOptions aimHelperOptions = new AimHelper.AimHelperOptions(itemType)
    ...
    protected static void handleRangedFire(Player ply, HashMap<String, Double> attrMapOriginal, ConfigurationSection weaponSection,
        ...
        EntityPlayer plyNMS = ((CraftPlayer) ply).getHandle();
        DamageHelper.DamageType damageType = DamageHelper.getDamageType(ply);
        ...
        // tweaks before firing, such as extra projectiles / special ammo conversion logic from weapons
        // note that in this section, the attributes from arrow used are not accounted for.
        // however, as those behavior do not spawn ammo-specific projectiles, ammo-wise balancing is not a problem.
        switch (itemType) {
                ...
                if (shouldFire) {
                    ...
                    for (int i = 0; i < extraProjectileAmount; i ++) {
                        EntityHelper.spawnProjectile(ply, fireLoc, fireVelocity, attrMapExtraProjectile,
                                DamageHelper.getDamageType(ply), extraProjectileType);
                    }
                }
                break;
            }
            ...
            case "烈风": {
                ...
                for (int i = -1; i <= 1; i ++) {
                    ...
                    EntityHelper.spawnProjectile(ply, fireLoc, fireVelocity, attrMapExtraProjectile,
                            DamageHelper.getDamageType(ply), "天蓝羽毛");
                }
                break;
            }
            case "洲陆巨弓": {
        ...
        if  (ammoConversion.size() <= 1) {
            ...
            if (ammoAttributeSection != null) {
                AttributeHelper.tweakAllAttributes(attrMap, ammoAttributeSection, true);
        ...
        for (int i = 0; i < fireAmount; i ++) {
            ...
            switch (itemType) {
                        ...
                        Set<HitEntityInfo> hitCandidates = HitEntityInfo.getEntitiesHit(
                                ...
                                (net.minecraft.server.v1_12_R1.Entity toCheck) ->
                                        toCheck instanceof EntityLiving &&
                                                DamageHelper.checkCanDamage(ply, toCheck.getBukkitEntity(), true));
                ...
                // below: those weapons should not shoot for some reason
                case "异象纳米枪": {
                    if (fireIndex <= 5)
                        fireVelocity = null;
                    break;
            ...
            case "渊泉远程套装": {
                ...
                if (! ply.getScoreboardTags().contains(coolDownTag)) {
                    ...
                    EntityHelper.spawnProjectile(ply, aimDir,
                            fireballAttrMap, DamageHelper.getDamageType(ply), projType);
                }
                break;
            }
            case "弑神者远程套装":
                    ...
                    case "镀金匕首Ex": {
                        ...
                        for (HitEntityInfo targetInfo : HitEntityInfo.getEntitiesHit(
                                ...
                                (e) -> (e instanceof EntityLiving) &&
                                        DamageHelper.checkCanDamage(ply, e.getBukkitEntity(), true))) {
        ...
        for (int i = 0; i < fireAmount; i ++) {
            ...
            switch (itemType) {
                ...
                case "星火凤凰雨": {
                    Vector offset = new Vector(Math.random() * 30 - 15, 20 + Math.random() * 20, Math.random() * 30 - 15);
                    fireVelocity = offset.clone().multiply(-1).normalize();
                    AimHelper.AimHelperOptions options = new AimHelper.AimHelperOptions()
                            .setAimMode(true)
                    ...
                    if (itemType.equals("光之舞") && i == 0) {
                        ...
                        if (charge++ >= 90) {
                            ...
                            EntityHelper.spawnProjectile(ply, ply.getEyeLocation().add(0, 15, 0), new Vector(),
                                    projAttrMap, DamageHelper.DamageType.MAGIC, "光之舞闪光");
                        }
                ...
                case "凋亡射线": {
                    ...
                    attrMap.put("damage", attrMap.get("damage") * (0.75 + 0.5 * manaRatio));
                    break;
                }
                case "激光加特林": {
                    if (swingAmount < 25)
            ...
            if (projectileName != null) {
                ...
                EntityHelper.ProjectileShootInfo shootInfo = new EntityHelper.ProjectileShootInfo(
                        ...
                        DamageHelper.getDamageType(ply), projectileName);
                switch (itemType) {
                    case "水晶风暴": {
                                ...
                                .setBlockHitFunction((Location hitLoc, MovingObjectPosition hitInfo) -> {
                                    ...
                                    if (spawnLava) {
                                        EntityHelper.spawnProjectile(ply, hitLoc, new Vector(),
                                                attrMap, DamageHelper.DamageType.MAGIC, lavaName)
                                    ...
                                    // has a chance to spawn a hand
                                    {
                                        if (Math.random() < 0.1) {
                                            ...
                                            EntityHelper.spawnProjectile(ply, spawnLoc, new Vector(),
                                                    attrMap, DamageHelper.DamageType.MAGIC, "怨戾之手")
                                                    .addScoreboardTag("ignoreCanDamageCheck");
                                        }
                                    }
                                });
    ...
    protected static boolean playerUseSummon(Player ply, String itemType, int swingAmount, String weaponType,
        ...
        boolean hasContactDamage = weaponSection.getString(
                "damageType", DamageHelper.DamageType.MELEE.internalName).equals(DamageHelper.DamageType.MELEE.internalName);
    ...
    public static void playerUseItem(Player ply) {
        ...
        if (!PlayerHelper.isProperlyPlaying(ply)) return;
        // call event, cancel swing if needed
        if (isWeaponUseCancelledByEvt(ply)) return;
        ...
        if (itemName.length() > 0) {
            ...
            if (weaponSection != null) {
                ...
                if (attrMap.getOrDefault("useCD", 0d) < 0.01) {
                    PlayerHelper.setupAttribute(ply);
                    attrMap = AttributeHelper.getAttrMap(ply);
                }
                // handle loading
                ...
                // "music instrument" weapons
                String musicInstrumentSound = weaponSection.getString("instrumentSound");
                if (musicInstrumentSound != null) {
                    double pitch = MathHelper.getVectorPitch(ply.getLocation().getDirection());
                    int note = (int) -Math.round(pitch * 24 / 180);
                    ply.getWorld().playSound(ply.getLocation(), musicInstrumentSound, SoundCategory.PLAYERS,
                            3f, (float) Math.pow(2, note / 12d));
                }
                // use weapon
