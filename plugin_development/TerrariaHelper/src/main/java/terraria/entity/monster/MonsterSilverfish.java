...
public class MonsterSilverfish extends EntitySilverfish {
    ...
    public MonsterSilverfish(World world) {
        super(world);
        die();
    }
    ...
    public MonsterSilverfish(Player target, String type, Location spawnLoc) {
        this(target, type, spawnLoc, false);
    }
    public MonsterSilverfish(Player target, String type, Location spawnLoc, boolean isMonsterPart) {
