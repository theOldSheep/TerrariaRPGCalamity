...
public class MonsterSpider extends EntitySpider {
    ...
    public MonsterSpider(World world) {
        super(world);
        die();
    }
    ...
    public MonsterSpider(Player target, String type, Location spawnLoc) {
        this(target, type, spawnLoc, false);
    }
    public MonsterSpider(Player target, String type, Location spawnLoc, boolean isMonsterPart) {
