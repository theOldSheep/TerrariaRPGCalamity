...
public class GuardianAttacker extends EntitySlime {
    ...
    public static final double BASIC_HEALTH = 216000 * 2, BASIC_HEALTH_BR = 364000 * 2;
    ...
    public GuardianAttacker(GuardianCommander commander) {
        ...
        {
            target = commander.target;
            MetadataHelper.setMetadata(bukkitEntity, MetadataHelper.MetadataName.BOSS_TARGET_MAP, commander.targetMap);
        }
