...
public class MourningWood extends EntitySlime {
    ...
    public MourningWood(Player summonedPlayer) {
        ...
        MetadataHelper.setMetadata(bukkitEntity, MetadataHelper.MetadataName.SPAWN_IN_EVENT, EventAndTime.Events.PUMPKIN_MOON);
        MetadataHelper.setMetadata(bukkitEntity, MetadataHelper.MetadataName.KILL_CONTRIBUTE_EVENT_PROGRESS, 187.5d);
